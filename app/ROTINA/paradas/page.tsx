...
export default function ParadasPage() {
  ...
  const groupedStops = useMemo(() => {
    ...
    return [
      { label: "Ocorrendo", items: occurring, tone: "bg-emerald-100 text-emerald-900" },
